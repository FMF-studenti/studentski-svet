...
\begin{clen}[logotip]
Svet ima svoj logotip z Gaussovo porazdelitvijo v koordinatnem sistemu in
napisom ``FMF Študentski svet'', kot prikazano na sliki~\ref{fig:logo}.
Logotipi so na voljo v bitni in vektorski obliki na
\url{https://svet.fmf.si/legal#logos}. Uporaba logotipa je dovoljena s
soglasjem ŠS FMF.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{ssfmf_logo_col.pdf}
    \caption{Logotip logotip ŠS FMF.}
    \label{fig:logo}
\end{figure}
\end{clen}
...
letnikov skupaj z njihovimi elektronskimi nalsovi. Svet predstavnike in njihove naslove objavi na
...
\hspace*{\fill}  Predsednik ŠS FMF UL
